module SolidStackWeb
  class JobsController < ApplicationController
    ...
    def index
      scope = EXECUTION_MODELS[@status].includes(:job)
      ...
      @queue_options    = EXECUTION_MODELS[@status].joins(:job).distinct.pluck("solid_queue_jobs.queue_name").sort
      @priority_options = EXECUTION_MODELS[@status].joins(:job).distinct.pluck("solid_queue_jobs.priority").sort
